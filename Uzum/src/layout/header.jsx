    ...
    <Box sx={{ flexGrow: 20 }}>
      <AppBar position="static" sx={{ bgcolor: "#fff", height: "100px", boxShadow: "none" }}>
        <Toolbar>
          ...
          <Button color="inherit" sx={{ color: "blue", backgroundColor: "lightgray", marginLeft: "15px", width: "8%" }}>
            Katalog
          </Button>
          ...
          <button style={{ backgroundColor: "gray", marginLeft: "10px", width: "40px", height: "43px" }}>
            <SearchIcon />
          </button>
          <Box sx={{ flexGrow: 1 }} />
